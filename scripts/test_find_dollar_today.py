...
os.environ["OPEN_EXCHANGE_APP_ID"] = "something"
...
@patch("find_dollar_today.RetrieveRateOpenExchange.get_today")
@patch("find_dollar_today.RetrieveRateOpenExchange.get_before")
